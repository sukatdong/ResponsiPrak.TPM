...
import 'package:responsipraktpm/ListCategoryPage.dart';
...
class _KategoriState extends State<Kategori> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Meal Category', textAlign: TextAlign.center),
        centerTitle: true,
      ),
      backgroundColor: Colors.grey[200], // Background color: Grey
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: Card(
              ...
              color: Colors.white, // Card background color: White
              child: Column(
